...
// Membuat variabel tampungan awal dengan nilai kosong
$name = $lahir = $address = $salary =$telpon = $kepala = "";
$name_err = $lahir_err = $address_err = $telpon_err = $kepala_err = "";
 
// Memporses data yang sudah disubmit
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // mengecek kesalahan input sebelum menyimpan ke database
    if(empty($name_err) && empty($lahir_err) && empty($address_err) && empty($telpon_err)){
        // query untuk insert data inputan ke database
